            ...
            steps {
                script {
                    ...
                    sshagent(['sshtoaws']) {
                        ...
                        sh "ssh -i /var/jenkins_home/greenworld.pem ubuntu@3.23.92.68 'source ~/.nvm/nvm.sh && cd /opt/docker-green/backenddocs && /home/ubuntu/.nvm/versions/node/v21.7.2/bin/jsdoc -c jsdoc.conf.json -r . -d ./docs'"
