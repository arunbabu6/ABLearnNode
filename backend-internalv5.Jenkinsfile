            ...
            steps {
                dir('client') {
                   ...
                   // sh 'dependency-check --project "MyProject" --scan .'
                    ...
                    dependencyCheck additionalArguments: '', odcInstallation: '9.0.9'
                    dependencyCheckPublisher pattern: 'dependency-check-report.xml' //additionalArguments: '', odcInstallation: '9.0.9'
                }
            }
        }
